...
# --- AYARLAR (GitHub Secrets üzerinden) ---
...
def process_ticker(ticker, df_h, df_d):
    try:
        ...
        # Filtre: En az 1 sinyal olmalı. Tek sinyal ise SMA 200 üstü şart.
        ...
        return {"type": "FULL" if score == 3 else ("CIFT" if score == 2 else "TEK"), "line": line}
    except: return None

# --- 4. VERİ ÇEKME VE ÇALIŞTIRMA ---
