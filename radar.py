...
# --- AYARLAR ---
TOKEN = "BURAYA_BOT_TOKEN_YAZ" # Botunun tokenini yaz
CHAT_ID = "-1003749853988"
BIST_LIST = "ACSEL, ADEL, ADESE, AGHOL, AGESA, AGROT, AKBNK, AKCNS, AKSA, AKSEN, ALARK, ALBRK, ALFAS, ARCLK, ASELS, ASTOR, BIMAS, BRSAN, CCOLA, DOAS, EREGL, FROTO, GARAN, HEKTS, ISCTR, KCHOL, KONTR, KOZAL, MGROS, PETKM, PGSUS, SAHOL, SASA, SISE, TCELL, THYAO, TOASO, TUPRS, VAKBN, YKBNK" # Listeyi istediğin kadar uzatabilirsin
